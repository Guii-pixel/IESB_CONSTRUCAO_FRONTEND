...
export default function page(props) {
    ...
    async function buscarAtor() {
        const resultado = await apiSerie.get("/person/" + id + "?language=pt-BR")
        console.log(resultado.data)
        setAtor(resultado.data)
    }

    async function buscarSerie() {
        const resultado = await apiSerie.get("/person/" + id + "/movie_credits?language=pt-BR")
        console.log(resultado.data.cast)
        setSerie(resultado.data.cast)
    }
